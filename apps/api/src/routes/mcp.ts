...
mcp.all('/', async (c) => {
  ...
  server.registerTool('list_exchange_fees', { description: 'Trading fees, withdrawal fees, and transfer times for all supported exchanges (Bithumb, Upbit, Coinone, GoPax, bitFlyer, WazirX, bitbank, Indodax, Bitkub, Binance, OKX, Bybit, KuCoin)', inputSchema: z.object({}) }, async () => proxy('/api/route/fees'))
