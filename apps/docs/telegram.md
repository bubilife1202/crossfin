...
| Command | Description |
|---------|-------------|
| `/route <from> <to> <amount>` | Find the cheapest transfer path across 12 exchanges |
...
| `/status` | Exchange network health (12 exchanges) |
...
- Data from 12 exchanges: Bithumb, Upbit, Coinone, GoPax, bitFlyer, WazirX, bitbank, Indodax, Bitkub, Binance, OKX, Bybit
